...
class CategoryProductsScreen extends StatelessWidget {
  ...
  List<Product> _productsFor() {
    if (category == 'New in') return ProductRepository.allProducts;
    // Map gender-style categories too.
    final genderMap = {'Women': 'Female', 'Men': 'Male'};
    final gender = genderMap[category];
    return ProductRepository.allProducts.where((p) {
      final byCategory = p.category.toLowerCase() == category.toLowerCase() ||
          // tolerate "T-Shirt" vs "T-Shirts"
          p.category.toLowerCase() ==
              category.toLowerCase().replaceAll(RegExp(r's$'), '');
      final byGender = gender != null && p.gender == gender;
