...
> A Flutter mobile application migrated from a web-based fashion and grooming platform. Built for a design competition, the app showcases AI-powered styling, virtual outfit previews, and hairstyle recommendations.
