...
public class FlutterOverlayWindowPlugin implements
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        ...
        // Only the first (main) engine sets WindowSetup.messenger.
        // The overlay engine also calls onAttachedToEngine and must NOT overwrite it,
        // or OverlayService.send() would loop back to the overlay instead of the main engine.
